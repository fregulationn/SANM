...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        base_feat = self.RCNN_base(base_share_feat)
        ...
        if self.training:
            if cfg.DCR.DCR_NET:
                ...
                dcr_feat = self.RCNN_base(res2_roi_pool) 
        ...
        if self.training:
            ...
            if cfg.DCR.DCR_NET:
                ...
                if cfg.DCR.MIMICK:
                    ...
                    # norm_dcr_feat = F.normalize(dcr_feat, dim= 1, p=2)
                    # norm_mimick_feat = F.normalize(mimick_feat, dim=1, p=2)
